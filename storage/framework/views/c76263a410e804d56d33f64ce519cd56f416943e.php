...
<div class="menu">
    <div class="logom">
        <p style="margin-left: 20px;color: #9fa5c6;font-size: 30px;font-family: 'Sitka Text'">WordPress</p>
    </div>
    <a class="menu-o" href="<?php echo e(route('home')); ?>">Главная</a>


    <div class="dropdown">
        <button style="font-size: 20px;font-family:Roboto, sans-serif " class="dropbtn">Контакты</button>
    </div>
...
<?php /**PATH Y:\ПАПКИ СТУДЕНТОВ\23\ПРОЕКТЫ МУРУГОВ\Рычков и Крылов\HELP\example-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>